...
export const ProjectInformation = ({ project }: ProjectInformationProps) => {
	return (
		<div className="grow flex flex-col border border-content/20 rounded-xl bg-base min-w-0">
			<div className="p-8 pb-6 flex items-start gap-4">
				...
				<div className="flex flex-col gap-2 items-start">
					...
					{/* Project description */}
					<p className="font-sm text-content/60 line-clamp-2">{project.description}</p>
					{/* GitHub link */}
